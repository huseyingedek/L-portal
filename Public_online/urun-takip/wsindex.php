      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            " /><text x="50%" y="50%" fill="#eceeef" dy=".3em">SATIŞLARINI LİSTELE</text>
                </svg>

                <div class="card-body">

                  <p class="card-text" style="color: black;">Satışları Listeleme Tablosu</p>
          ...
          <div class="col-md-4">
            ...
            <a href="satis-ekle/" style="text-decoration:none;">
            ...
            " /><text x="50%" y="50%" fill="#eceeef" dy=".3em">SATIŞ EKLE</text>
                </svg>

                <div class="card-body">

                  <p class="card-text" style="color: black;">Satış Ekleme Formu</p>
