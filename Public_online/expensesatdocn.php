			...
			$('#exp_grid').jtable({
						...
						fields: {	
							...
							ADDTOCURRENT: {
								title: '',
								display: function (data) {
									return '<input type="button" value="Ekle" onclick="fn_exp_add();" style="color:white; background-color:#0099FF;"></input>';
								}								
							},
							EXPCONF: {
								title: '',
								display: function (data) {
									if( data.record.STATUS != "0" ){
										switch (data.record.STATUS) {
											case "2":
												return '<input type="text" value="Onaylı" style="background-color:#00cd66; color:white;" readonly />';
												break;
											default:
												return '<span></span>';
										}	
							...
							EXPRFS: {
								...
								display: function (data) {
									if( data.record.STATUS != "0" ){
										switch (data.record.STATUS) {
											case "1":
												return '<input type="text" value="Red" style="background-color:#c60000; color:white;" readonly />';
												break;
											default:
												return '<span></span>';
										}	
