...
if($status == "failure"){
    echo '<script>
    window.location.href = "https://online.lizaypirlanta.com/bayi-odemeleri/odeme-sayfasi/index.php?status=err";
  </script>';
    exit;
}
    ...
    elseif($payWithIyzico->getPaymentStatus() === "SUCCESS"){
        ...
        try {
          ...
          $query = "INSERT INTO IYZICO_BAYILER (odeme_conversation_id, odeme_payment_id,
          ...
          $params = [
              ...
              if($query){
                echo '<script>
                  window.location.href = "https://online.lizaypirlanta.com/bayi-odemeleri/odeme-sayfasi/index.php?status=success";
                </script>';
                exit;
              }else{
                echo '<script>
