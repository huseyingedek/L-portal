...
$query = "SELECT * FROM `KAMPANYALAR` ORDER BY `KAMPANYALAR`.`kampanya_tarih` DESC";
    ...
    <header>
        <div class="navbar navbar-dark bg-dark shadow-sm">
            ...
            <div class="container d-flex justify-content-between">
                ...
                <a href="kampanya-ekle.php" class="navbar-brand d-flex align-items-center">
                    <p>
                        <i class="fa fa-edit"></i><strong> Kampanya Ekle</strong>
                    </p>
                </a>
                <?php } ?>
            </div>
                ...
                <div class="row">
                    <?php if ($result) {
                        ...
                        foreach ($result as $row) {
                            ...
                            $kampanya_dosya_adi = $row['kampanya_dosya_adi'];

                            $dosya_adi = dosyaAdiOlustur($kampanya_gorsel_baslik); //sunucuda oluşturulacak dosyanın adı
                            ...
                            if (!file_exists($dosya_adi)) {
                                ...
                                \$query = \"SELECT * FROM `KAMPANYALAR` WHERE kampanya_dosya_adi = '$dosya_adi'\";
                                try {
                                    \$result = \$db->select(\$query);
                                } catch (PDOException \$e) {
                                    echo \"Sorgu hatası: \" . \$e->getMessage();
                                ...
                                <a href="<?php echo $dosya_adi; ?>" style="text-decoration:none;">
                                    <div class="card mb-4 shadow-sm flip-2-hor-bottom-1">
                                        <svg class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                                            <title><?php echo $kampanya_baslik; ?></title>
                                            <rect width="100%" height="100%" fill="<?php echo $rect_rengi; ?>" />
                                            <text x="50%" y="50%" fill="white" bolder dy=".3em">
                                                <tspan font-weight="bold"><?php echo $kampanya_gorsel_baslik; ?></tspan>
                                            </text>
                                        </svg>
                                        <div class="card-body">
                                            <p class="card-text" style="color: black;"><?php echo $kampanya_baslik; ?></p>
                                        </div>
                                    </div>
                                </a>
                            </div>
