...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
		...
		$('#exp_paratp').val(record.exp_paratp);
        ...
        <div style="width:100%">
            <table style="width:100%">  
                ...
                <tr>
					...
					<select id="exp_paratp" name="exp_paratp" style="width:90px; min-width:50px;">
					<option value="0" selected>TL</option>
					<option value="1">DOLAR</option>
					<option value="2">EURO</option>
					<option value="3">HAS</option>
					<option value="4">STERLİN</option>
					<option value="5">İSVİÇRE FRANGI</option>
					</select>
					</td>
                </tr>  
                <tr>
				...
				<tr>
                    <td class="left-label">Ödeme Türü</td>
                    <td>
					<select id="ppaytype" name="ppaytype" style="width:90px; min-width:50px;">
