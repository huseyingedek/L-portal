<?php	  
	class caniasConnector
	{
		...
		public function wsCanias($function, array $params)
		{
			...
			$sessionId = $soap_client->call("login", [
				'00',
				'T',
				'NEW',
				'CANIAS',
			...
			$ress = $soap_client->call("callIASService", [
				$sessionId,
				$function,
				$Argss,
				'string',
			...
			$soap_client->call("logout", [$sessionId]);
		...
		public function wsGetResponse()
		{
			return $this->wsCaniasResponse;
		}

		public function wsGetResponseforJtable()
		{
