...
interface Props {
  usern: string;
  isStoreUser: boolean;
  stats: { prosedur: number; kampanya: number; ik: number };
...
const STATS = [
  ...
  { key: 'kampanya'      as const, label: 'Anlaşmalı Kurum',  icon: 'fa-solid fa-tag',         color: '#f59e0b', href: '/calisankampanyalari' },
...
export default function DashboardClient({ usern, isStoreUser, stats, sonKampanyalar, sonIK }: Props) {
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16, overflow: 'hidden' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 20px 14px', borderBottom: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: 13.5, color: 'var(--text)' }}>Anlaşmalı Kurumlar</span>
              </div>
            </div>
            <div>
